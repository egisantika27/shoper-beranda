...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const hasModalParam = params.has('ref') || params.has('from');

    if (hasModalParam) {
        // Jika ada parameter untuk modal, sembunyikan konten utama
        ...
        // Jika tidak ada parameter modal, tampilkan konten normal
        renderProfile();
        renderLinks();
        renderSocials();
    }
