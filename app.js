...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const profileData = {
        ...
        picture: "logo shoper.png" // Ganti dengan URL foto profil Anda
    };
    ...
    // [DIUBAH] Ikon sosial media diganti menjadi Instagram, WhatsApp, dan YouTube
    const socialsData = [
        {
            name: "Instagram",
            url: "https://www.instagram.com/_egisantika?igsh=MWJuZjRodjc4NGRnbg==", // Ganti dengan username Instagram Anda
            // Ikon SVG inline untuk performa dan kemudahan kustomisasi
        ...
        {
            name: "WhatsApp",
            url: "https://wa.me/628980007065", // Ganti dengan nomor WhatsApp Anda (format internasional)
        ...
        {
            name: "YouTube",
            url: "https://youtube.com/channel/channel_anda", // Ganti dengan URL channel YouTube Anda
    ...
    function renderLinks() {
        ...
        linksData.forEach((link, index) => {
            ...
            linkElement.target = '_blank'; // Membuka link di tab baru
            
            // Menambahkan delay animasi yang berbeda untuk setiap link
